...
document.addEventListener('DOMContentLoaded', () => {
    showMain(1); // Mostrar la primera pestaña por defecto
    updateAlarmHistoryDisplay();
    adjustForMobile(); // Llamar a la función de ajuste móvil
});

// Modificar la función sendMessage para manejar mejor el desplazamiento en móviles
function sendMessage() {
    // ... (código existente) ...
...
// Modificar la función showNotificationPopup para mejorar la experiencia en móviles
